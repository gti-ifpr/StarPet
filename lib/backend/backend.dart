...
import 'schema/formulario_denuncia_record.dart';
...
export 'schema/formulario_denuncia_record.dart';
export 'schema/imagens_record.dart';
export 'schema/users_record.dart';
export 'schema/photos_record.dart';

/// Functions to query FormularioDenunciaRecords (as a Stream and as a Future).
Future<int> queryFormularioDenunciaRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FormularioDenunciaRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FormularioDenunciaRecord>> queryFormularioDenunciaRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      FormularioDenunciaRecord.collection,
      FormularioDenunciaRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FormularioDenunciaRecord>> queryFormularioDenunciaRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
